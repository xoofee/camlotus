...
class Helper {
  ...
  /// Set manual focus distance in diopters (Android API 28+). 0 = infinity.
  static Future<void> setFocusDistance(
          MediaStreamTrack videoTrack, double diopters) =>
      CameraUtils.setFocusDistance(videoTrack, diopters);

  /// Max focus distance in diopters for this camera (Android). 0 = fixed focus.
