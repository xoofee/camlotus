...
public class MethodCallHandlerImpl implements MethodCallHandler, StateProvider {
  ...
  public void onMethodCall(MethodCall call, @NonNull Result notSafeResult) {
    ...
    switch (call.method) {
      ...
      case "mediaStreamTrackSetFocusDistance": {
        String trackId = call.argument("trackId");
        double diopters = call.argument("diopters");
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
          cameraUtils.setFocusDistance(trackId, diopters, result);
        } else {
          result.success(null);
        }
        break;
      }
      case "mediaStreamTrackGetMaxFocusDistanceDiopters": {
        String trackId = call.argument("trackId");
